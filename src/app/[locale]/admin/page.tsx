              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="flex gap-4 w-full">
                  ...
                  <button
                    ...
                    className="hidden md:flex md:items-center md:justify-center flex-1 rounded-lg bg-white/25 px-6 py-2 font-medium text-white hover:bg-white/35 focus:outline-none focus:ring-2 focus:ring-white/70 transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
                  >
                    Copy Image
                  </button>
                </div>
